...
- Name: smoke.spec.ts >> ResumeCraft smoke tests >> examples page loads
...
Locator: getByRole('heading', { name: /Resume Examples/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Resume Examples/i })
